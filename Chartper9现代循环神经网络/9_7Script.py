...
def bleu(pre_seq,label_seq,k):#@save
    """计算BLEU"""
    pre_tokens,label_tokens = pre_seq.split(' '),label_seq.split(' ')
...
# i feel so hungry when i finished this script... 2022-02-12 18:22 :(